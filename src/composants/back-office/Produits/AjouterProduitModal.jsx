...
const AjouterProduitModal = ({ isOpen, onClose, onSave, produitAEditer, categories }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!localStorage.getItem("userToken")) {
             alert("Veuillez vous connecter pour créer ou éditer un produit.");
             return;
        }
        ...
        } else if (!produitAEditer) {
             alert("Veuillez sélectionner une image avant de créer le produit.");
             return;
        }
