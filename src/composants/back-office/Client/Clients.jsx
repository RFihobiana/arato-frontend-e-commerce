...
const Clients = () => {  const [clientsData, setClientsData] = useState([
    { id: 1, nom: "Dupont", prenom: "Alice", email: "alice.dupont@mail.fr", commandes: 5, dateInscription: "2024-01-15" },
    { id: 2, nom: "Martin", prenom: "Bernard", email: "b.martin@mail.fr", commandes: 12, dateInscription: "2023-11-20" },
    { id: 3, nom: "Petit", prenom: "Claire", email: "claire.petit@mail.fr", commandes: 1, dateInscription: "2024-05-01" },
  ]);
  ...
  const handleSaveClient = (client, isEditing) => {
    ...
    console.log(`Action de sauvegarde : ${isEditing ? 'Mise à jour' : 'Création'}`, client);
    ...
    if (isEditing) {
        ...
        setClientsData([...clientsData, { ...client, id: newId, commandes: 0, dateInscription: new Date().toISOString().slice(0, 10) }]);
    }
  };
          ...
          <table className="clients-table">
            ...
            <tbody>
              {clientsData.map(client => (
                <tr key={client.id}>
                  <td>{client.id}</td>
                  <td className="client-name">{client.prenom} {client.nom}</td>
